...
-- =============================================
-- Explicitly cast scores to numeric to match function signature
-- This fixes the "Returned type real does not match expected type numeric" error.
...
BEGIN
    ...
    -- Final ranking with explicit casts to numeric
    SELECT
        sc.sid, 
        sc.s_service_id, 
        sc.s_title, 
...
COMMENT ON FUNCTION hybrid_search IS 'Fixed hybrid search with strict numeric return types for scores';
